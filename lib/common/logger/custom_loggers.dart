...
mixin InteractorLogger implements LoggyType {
  @override
  Loggy<InteractorLogger> get loggy =>
      Loggy<InteractorLogger>('Interactor: $runtimeType');
}
...
mixin AuthenticationLoggy implements LoggyType {
  @override
  Loggy<AuthenticationLoggy> get loggy =>
      Loggy<AuthenticationLoggy>('Authentication');
}

class NotificationsLoggy implements LoggyType {
  @override
  Loggy<NotificationsLoggy> get loggy =>
      Loggy<NotificationsLoggy>('Notifications');
}
